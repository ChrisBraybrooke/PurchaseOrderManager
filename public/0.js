...
var update = __webpack_require__(42)("0018f24a", content, false, {});
      ...
      _c(
        ...
        _vm._l(_vm.products, function(product, key) {
          return _c("product-row", {
            key: key,
            attrs: { id: key, product: product, products: _vm.products }
          })
        })
      )
    ]),
          ...
          _c("td", { attrs: { scope: "col" } }, [
            _c("div", { staticClass: "input-group input-group-sm" }, [
              ...
              _c("input", {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.products.shipping,
                    expression: "products.shipping"
                  }
                ],
                ...
                domProps: { value: _vm.products.shipping },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.products, "shipping", $event.target.value)
                  }
                }
              })
            ])
